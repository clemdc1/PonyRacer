...
describe('RegisterComponent', () => {
  ...
  it('should display a form to register', () => {
    ...
    const passwordForm = userForm.get('passwordForm')!;
    ...
    const passwordCtrl = passwordForm.get('password')!;
    ...
    const confirmPasswordCtrl = passwordForm.get('confirmPassword')!;
  ...
  it('should have a password confirmation', () => {
    ...
    // given a form
    const passwordForm = fixture.componentInstance.userForm.get('passwordForm')!;
    expect(passwordForm.valid).toBe(false);
    const passwordCtrl = passwordForm.get('password')!;
